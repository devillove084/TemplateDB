...
use sqlparser::ast::{
    BinaryOperator, ColumnDef, Expr, FunctionArg, FunctionArgExpr, GroupByExpr, Ident, ObjectName,
...
impl SqlparserSelectBuilder {
    ...
    pub fn from_table(self, table_name: String) -> Self {
    ...
    pub fn from_table_function(self, table_function_name: &str) -> Self {
        let relation = TableFactor::Table {
