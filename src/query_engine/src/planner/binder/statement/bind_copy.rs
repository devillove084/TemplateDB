...
use crate::planner::{BindError, Binder, SqlparserResolver, LOGGING_TARGET};
            ...
            Statement::Copy {
                ...
                match source {
                    sqlparser::ast::CopySource::Table {
                        ...
                        let insert_from_sql = Self::convert_copy_from_to_insert_sql(
                            table_name, columns, target, options,
                        )?;
                        debug!(
                    ...
                    sqlparser::ast::CopySource::Query(_) => todo!(),
                }
            }
