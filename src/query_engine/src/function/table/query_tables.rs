...
impl QueryTablesFunc {
    ...
    fn bind_func(
        ...
        Ok(Some(FunctionData::QueryTablesData(Box::new(data))))
    }
    ...
    fn tables_func(
        ...
        if let Some(FunctionData::QueryTablesData(data)) = input.bind_data {
