...
use crate::{
    node_server, segment_request_union, segment_response_union,
    stream::common::error::{Error, Result},
    stream_request_union, stream_response_union, tenant_request_union, tenant_response_union,
    CreateStreamRequest, CreateStreamResponse, CreateTenantRequest, CreateTenantResponse,
    DescribeStreamRequest, DescribeStreamResponse, DescribeTenantRequest, DescribeTenantResponse,
    GetSegmentRequest, GetSegmentResponse, HeartbeatRequest, HeartbeatResponse, ListStreamsRequest,
...
impl Server {
    // FIXME(luhuanbing) Support address lookup
    ...
    pub fn into_service(self) -> node_server::NodeServer<Self> {
        node_server::NodeServer::new(self)
    }
}
    ...
    async fn handle_stream_union(
        ...
        let res = match req {
            ...
            Request::DescribeStream(req) => {
                println!("handle describe stream: {:?}", req);
