...
impl<L: ActiveLauncher> StreamMixin<L> {
    ...
    fn handle_truncate(&mut self, sequence: u64, sender: oneshot::Sender<Result<()>>) {
        ...
        // TODO(luhuanbing) truncate entries from master and state machine.
    ...
    fn handle_promote(&mut self, promote: Promote) {
        ...
        // FIXME(luhuanbing) cancel subscribing when the receiving end are closed.
...
/// FIXME(luhuanbing) support back pressure.
