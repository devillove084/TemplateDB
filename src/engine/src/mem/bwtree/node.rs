...
use super::{
    data::{DataItem, Index, IndexItem, Key, Value},
    datapage::DataPageIter,
    indexpage::IndexPageIter,
    iter::{ForwardIter, MergingIter, OrderedIter, SeekableIter},
    page::PageRef,
    pagestore::store::PageInfo,
    pagetable::{MIN, NAN},
};

pub const NULL_INDEX: Index = Index::new(NAN, 0);
pub const ROOT_INDEX: Index = Index::new(MIN, 0);
