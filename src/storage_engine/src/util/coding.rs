...
mod tests {
    ...
    fn test_encode_fixed_32() {
        let mut tests: Vec<(u32, Vec<u8>, Vec<u8>)> = vec![
            ...
            (u32::MAX, vec![0; 4], vec![255, 255, 255, 255]),
            (u32::MAX, vec![0; 6], vec![255, 255, 255, 255, 0, 0]),
        ];
    ...
    fn test_decode_fixed_32() {
        let mut tests: Vec<(Vec<u8>, u32)> = vec![
            ...
            (vec![0, 1], 256u32),
            (vec![0, 2, 0, 0], 512u32),
            (vec![255, 255, 255, 255], u32::MAX),
            (vec![255, 255, 255, 255, 0, 0], u32::MAX),
            (vec![255, 255, 255, 255, 1, 0], u32::MAX),
        ];
    ...
    fn test_decode_fixed_64() {
        let mut tests: Vec<(Vec<u8>, u64)> = vec![
            ...
            (vec![255, 255, 255, 255, 255, 255, 255, 255, 0, 0], u64::MAX),
            (vec![255, 255, 255, 255, 255, 255, 255, 255, 1, 0], u64::MAX),
        ];
        for (src, expect) in tests.drain(..) {
