...
use crate::{
    error::TemplateResult, iterator::Iterator, memtable::arena::Arena, util::comparator::Comparator,
};
                ...
                unsafe {
                    ...
                    match &(*prev[i]).next_nodes[i].compare_exchange(
                        ...
                        Err(_) => {
                            ...
                            if p == n {
                                // In TemplateDB, this should never happen
...
mod tests {
    ...
    use super::*;
    use crate::{memtable::arena::OffsetArena, util::comparator::BytewiseComparator};
