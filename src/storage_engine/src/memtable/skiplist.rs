...
use super::arena::*;
use crate::{error::TemplateResult, iterator::Iterator, util::comparator::Comparator};
...
//         // just use MAX_HEIGHT as capacity because it's the largest value that node.height can
// have         let mut prev_nodes = vec![skl.head; MAX_HEIGHT];
