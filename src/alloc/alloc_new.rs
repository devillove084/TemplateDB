...
use super::slag::{PageAlloc, Metadata, compute_metadata, PageCleanup};
#[allow(unused_imports)]
use super::frontend::{Depot, Frontend};
use super::util::{mmap, Lazy, LazyInitializable};
use super::source::MemorySource;
//use super::bagpipe::bag::WeakBag;
use super::source::MmapSource;
...
unsafe impl<M: MemorySource> Allocator for ElfMalloc<M> {
...
unsafe impl<M: MemorySource> Allocator for OwnedElfMalloc<M> {
